...
urlpatterns = [
    ...
    re_path(r'^places/(?P<slug>[\w\-]+)/$', views.place, name='place'),
    re_path(r'^news/(?P<slug>[\w\-]+)/$', views.news_post, name='news_post'),
    re_path(r'^meetings/(?P<slug>[\w\-]+)/$', views.meeting, name='meeting'),
    re_path(r'^referees/(?P<slug>[\w\-]+)/$', views.referee, name='referee'),
    re_path(r'^staff/(?P<slug>[\w\-]+)/$', views.staff, name='staff'),
    re_path(r'^members/(?P<slug>[\w\-]+)/$', views.member, name='member'),
    re_path(r'^teams/(?P<slug>[\w\-]+)/$', views.team, name='team'),
